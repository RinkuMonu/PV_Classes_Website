  ...
  return (
    <div className="w-full border-2 border-[#009FE3]/20 bg-white rounded-md shadow-2xl flex overflow-hidden relative">
      ...
      <div className="w-64 border-r-2 border-[#009FE3]/20 bg-gradient-to-b from-[#00316B]/5 via-white to-[#87B105]/5 relative">
        ...
        <div className="p-2">
          {categories.map((cat) => (
            <button
              key={cat._id}
              className={`w-full text-left px-4 py-4 mb-2 rounded-xl transition-all duration-300 relative overflow-hidden group ${
            ...
            >
              ...
              <span className="relative z-10 font-semibold">{cat.name}</span>
            </button>
          ))}
        </div>
      </div>
      ...
      <div className="flex-1 bg-gradient-to-br from-white to-[#009FE3]/5 p-6">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-[#00316B] mb-2">{activeCategory?.name} Exams</h2>
        ...
        <div className="flex gap-8 border-b-2 border-[#009FE3]/20 mb-6 overflow-x-auto scrollbar-thin scrollbar-thumb-[#87B105]/50 pb-2">
          {examTypes.map((type) => (
            <button
              key={type._id}
              className={`pb-3 px-2 transition-all duration-300 whitespace-nowrap relative ${
