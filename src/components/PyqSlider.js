    ...
    return (
        <section className="py-8 px-4 md:px-20">
            ...
            {/* <div className="flex justify-center mt-4 space-x-4" style={{ position: 'relative', zIndex: 10 }}>
                <button className="pyq-prev bg-[#00316B] text-white p-2 rounded-full hover:bg-blue-900 transition">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
                    </svg>
                </button>
                <button className="pyq-next bg-[#00316B] text-white p-2 rounded-full hover:bg-blue-900 transition">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
