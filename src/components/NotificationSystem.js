...
//             className="mb-4 w-full bg-[#009FE3] text-white py-2 rounded-md hover:bg-blue-600 transition-colors"
//           >
//             Set Preferences
//           </button>
...
//           <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 bg-white border border-green-300 rounded-lg shadow-2xl z-50 p-6">
//             <div className="flex justify-between items-center mb-4">
...
//                     className="mr-2 h-4 w-4 text-[#009FE3] focus:ring-[#009FE3] border-gray-300 rounded"
//                   />
//                   <label htmlFor={`cat-${category._id}`} className="text-sm">
//                     {category.name}
//                   </label>
//                 </div>
//               ))}
...
//                 className="px-4 py-2 text-sm bg-[#009FE3] text-white rounded-md hover:bg-blue-600 transition-colors"
//               >
//                 Save Preferences
//               </button>
//             </div>
