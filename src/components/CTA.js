...
export default function OfferSection() {
  return (
    ...
    >
      <div className="relative w-full max-w-7xl rounded-3xl p-6 sm:p-10 lg:p-14 bg-gradient-to-br from-[#00316b] via-[#204972] to-[#616602] text-white shadow-2xl flex flex-col md:flex-row items-center justify-between gap-10 md:gap-14 overflow-hidden">
        ...
        {/* Left Text Section */}
        <div className="relative z-10 w-full md:w-1/2 text-center md:text-left md:ml-6 lg:ml-16">
          {/* Tag */}
          <div className="mb-3">
          ...
          {/* Button (optional, kept commented) */}
          {/*
          <button className="group relative bg-gradient-to-r from-white to-blue-50 text-[#00316b] font-bold px-6 py-3 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border-2 border-white/20">
        ...
        <div className="relative w-full md:w-1/2 flex justify-center">
          <div className="relative">
            ...
            <Image
              ...
              width={700}
              height={700}
              className="relative z-10 w-full max-w-[160px] sm:max-w-[200px] md:max-w-[240px] lg:max-w-[280px] h-auto object-contain drop-shadow-2xl"
            />

            <div className="absolute -top-5 -right-5 w-8 h-8 bg-[#87B105] rounded-full flex items-center justify-center text-white text-sm animate-bounce">
              📚
            </div>
            <div className="absolute -bottom-3 -left-3 w-6 h-6 bg-[#009FE3] rounded-full flex items-center justify-center text-white text-xs animate-pulse">
              ⭐
            </div>
          </div>
        </div>
