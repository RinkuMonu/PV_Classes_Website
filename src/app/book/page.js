  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row gap-6 p-4 sm:p-6 lg:p-8">
        ...
        <aside className="bg-white rounded-xl shadow-lg p-4 w-full lg:w-64 flex flex-row lg:flex-col gap-2 overflow-x-auto lg:overflow-visible sticky top-4 h-fit border border-gray-100">
