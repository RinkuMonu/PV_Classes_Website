                    ...
                    <Link href={`/test-series/${series?._id}`} className="block">
                      <div className="px-4 pt-4">
                        <div className="flex justify-between items-start">
                          ...
                          {series?.title_tag && (
                            <span className="bg-[#788406] text-white/90 text-xs px-2 py-1 rounded-full font-semibold shadow-sm">
                              {series?.title_tag}
                            </span>
                          )}
                        </div>
                        ...
                        <div className="relative w-full h-56 px-0 mt-3">
                          <div className="relative w-full h-full rounded-lg overflow-hidden">
                            ...
                            {series?.total_tests > 0 && (
                              <div className="absolute bottom-2 left-3 bg-[#788406] text-white/90 px-3 py-1 text-xs font-bold rounded-full shadow-md">
