 ...
 <div className="px-16 py-12 bg-[#E6EEF5]">
      ...
      <div className="bg-white shadow-md rounded-lg border-l-4 border-[#616602] p-6 mb-8">
        ...
        <p className="text-gray-700 mb-3">
          Our website DOES NOT trade or sell your personal information in any
          manner, except as specified herein or if you express your consent
          towards the same.
        </p>
        ...
        <ul className="list-disc pl-6 text-gray-700 mt-2 space-y-1">
          ...
          <li>
            To respond to your concerns, inquiries or requests for information
            about the services we offer;
          </li>
          <li>
            To provide you with information about our services/products and send
            you materials, offers, and updates.
          </li>
        </ul>
      </div>
