      ...
      <section className="relative z-10 pt-6 md:pt-4 bg-gray-50 min-h-screen">
        <div className="mx-auto max-w-[1160px] px-4 py-8 flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            {/* Our Features */}
            <div className="bg-white rounded-xl shadow-sm p-6 mb-6 border border-gray-100 mt-4">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 mb-6 border border-gray-100">
              <h2 className="text-xl font-bold text-[#204972] mb-6 border-b pb-3 flex items-center">
                <svg
                  className="w-5 h-5 mr-2 text-[#204972]"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V9l-4-4H4z" />
                  <path d="M8 1v4a2 2 0 002 2h4" />
                </svg>
                Free Notes with this Course
              </h2>
              ...
              <div className="flex items-center justify-between bg-gradient-to-r from-blue-50 to-indigo-50 p-5 rounded-xl border border-gray-100 hover:shadow-md transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Download and read free notes specially curated for this course.
                  </p>
                </div>

                <Link
                  href="/notes"
                  className="px-5 py-2 bg-[#204972] text-white text-sm font-medium rounded-lg hover:bg-[#183a5c] transition-colors duration-300"
                >
                  View Notes
                </Link>
